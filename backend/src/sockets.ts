...
function startSockets() {
    ...
    var matches : any[] = [];
    var words : string[] = [];
    var correctWords : boolean[] = []
    var numbers : number[] = [];
    var correctNumbers : boolean[] = [];
    var combinations : any[] = [];
    var allPairs : any[] = [];
    var allRightColumns : any[] = [];
    var settedPairs : boolean[] = [];
    ...
    function getRightColumn(pairGame : any) {
        var rightColumn = [];
